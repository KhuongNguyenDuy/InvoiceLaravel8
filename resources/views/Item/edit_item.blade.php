@extends('layout')
@section('title-detail', 'Sửa thông tin Item')
@section('library')
...
<div style="font-size:0.9rem; margin: auto; width:80%;border: solid 1px gray;padding:15px;">
    ...
    <form action="{{URL::to('/edit-item')}}" method="post" name="form_edit_item" onsubmit="return validateForm()">
         @csrf
         <!--row name Item-->
        <div class="form-row">
...
function validateForm() {
    ...
    let name = document.forms["form_edit_item"]["item_name"].value;
    let price = document.forms["form_edit_item"]["item_price"].value;
